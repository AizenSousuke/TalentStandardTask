...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talentservicesidentitynik.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
