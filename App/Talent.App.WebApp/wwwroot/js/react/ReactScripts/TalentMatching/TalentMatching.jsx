...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'https://talentservicestalentnik.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'https://talentservicestalentnik.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'https://talentservicesprofilenik.azurewebsites.net/profile/profile/addTalentSuggestions',
